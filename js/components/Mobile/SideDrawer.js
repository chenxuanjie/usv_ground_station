    ...
    return (
      <>
        ...
        <div className={`absolute top-0 left-0 h-full w-72 bg-slate-950/95 border-r border-cyan-500/30 z-[55] transform transition-transform duration-300 ease-out flex flex-col ${open ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="p-4 border-t border-cyan-900/30 bg-slate-900/50 text-[10px] text-slate-600 font-mono">
            <a
              href="https://github.com/chenxuanjie/usv_ground_station"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 text-slate-600 hover:text-cyan-300 transition-colors"
            ...
            >
              ...
              <span className="tracking-wider">{t.mobile_footer} · GitHub</span>
            </a>
          </div>
        </div>
      </>
