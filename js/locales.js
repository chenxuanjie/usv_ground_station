...
const AppTranslations = {
    zh: {
        ...
        loop_on: "巡航: 开启 (1)",
        loop_off: "巡航: 关闭 (0)",
        control_switch_frame: "控制切换帧",
        control_switch_hint: "通过 C 报文切换运行模式、任务和控制器。当前阶段仅发送，不做 X 应答闭环。",
        send_control_switch: "发送控制切换 (C)",
        toast_control_switch_sent: "控制切换报文已发送",
        toast_control_switch_send_failed: "发送控制切换失败：未连接设备",
        log_control_switch_sent: "指令：已发送控制切换",
        c_field_mode: "运行模式",
        c_field_task: "任务类型",
        c_field_planner: "规划器",
        c_field_guidance: "制导律",
        c_field_heading_controller: "航向控制器",
        c_field_speed_controller: "速度控制器",
        c_mode_debug: "调试",
        c_mode_task: "任务",
        c_task_none: "无任务",
        c_task_waypoint_nav: "航点导航",
        c_task_auto_nav: "自动航行",
        c_task_station_keep: "定点保持",
        c_task_joystick_control: "摇杆控制",
        c_planner_none: "无规划器",
        c_planner_xxx: "规划器 xxx",
        c_planner_astar: "A* 规划器",
        c_planner_hybrid_astar: "Hybrid A* 规划器",
        c_planner_dwa: "DWA 规划器",
        c_guidance_none: "无制导律",
        c_guidance_waypoint_tracking: "航点跟踪",
        c_guidance_los: "LOS",
        c_heading_controller_none: "无航向控制器",
        c_heading_controller_pid: "PID",
        c_heading_controller_ai_pid: "AI-PID",
        c_speed_controller_none: "无速度控制器",
        c_speed_controller_fix_pwm: "固定 PWM",
        c_speed_controller_pid: "PID",
        ...
        menu_load_route: "📂 加载航线",
        menu_save_route: "💾 保存航线",
        ...
        desc_heading_reference: "按正北/正东为0°",
        heading_mode_north_cw: "标准",
        heading_mode_east_ccw: "REP",
        style_cyber: "赛博",
        style_ios: "iOS",
        boat_style: "船体样式",
        ...
        desc_port: "PORT",
        btn_save: "保存配置",
        btn_save_new_route: "新建保存",
        btn_overwrite_route: "覆盖该航线",
        btn_cancel: "取消",
        ...
        route_library: "航线库",
        route_name: "航线名称",
        route_name_placeholder: "输入航线名称",
        route_name_required: "请输入航线名称",
        no_saved_routes: "暂无已保存航线",
        current_points: "当前点数",
        route_points: "点数",
        save_route_hint: "将当前地图上的航点保存到航线库",
        unnamed_route: "未命名航线",
        route_delete_confirm: "确定删除航线“{name}”？",
        route_load_confirm_replace: "当前航线有未保存修改，是否放弃修改并加载选中的航线？",
        route_save_exists_confirm: "已存在同名航线，是否覆盖？",
        route_favorite: "设为常用",
        route_unfavorite: "取消常用",
        route_save_failed: "保存航线失败",
        route_rename_failed: "重命名航线失败",
        route_delete_failed: "删除航线失败",
        route_favorite_failed: "更新常用航线失败",
        route_load_failed: "加载航线失败",
        toast_route_saved: "航线已保存",
        toast_route_loaded: "航线已加载",
        toast_route_deleted: "航线已删除",
    ...
    en: {
        ...
        loop_on: "LOOP: ON (1)",
        loop_off: "LOOP: OFF (0)",
        control_switch_frame: "CONTROL SWITCH FRAME",
        control_switch_hint: "Send a C frame to switch mode, task, planner, guidance, and controller. This step only sends C and does not process X acknowledgements yet.",
        send_control_switch: "SEND CONTROL SWITCH (C)",
        toast_control_switch_sent: "Control switch frame sent",
        toast_control_switch_send_failed: "Control switch send failed: not connected",
        log_control_switch_sent: "CMD: Sent control switch",
        c_field_mode: "MODE",
        c_field_task: "TASK",
        c_field_planner: "PLANNER",
        c_field_guidance: "GUIDANCE",
        c_field_heading_controller: "HEADING CTRL",
        c_field_speed_controller: "SPEED CTRL",
        c_mode_debug: "DEBUG",
        c_mode_task: "TASK",
        c_task_none: "NONE",
        c_task_waypoint_nav: "WAYPOINT NAV",
        c_task_auto_nav: "AUTO NAV",
        c_task_station_keep: "STATION KEEP",
        c_task_joystick_control: "JOYSTICK",
        c_planner_none: "NONE",
        c_planner_xxx: "PLANNER XXX",
        c_planner_astar: "A*",
        c_planner_hybrid_astar: "HYBRID A*",
        c_planner_dwa: "DWA",
        c_guidance_none: "NONE",
        c_guidance_waypoint_tracking: "WAYPOINT TRACK",
        c_guidance_los: "LOS",
        c_heading_controller_none: "NONE",
        c_heading_controller_pid: "PID",
        c_heading_controller_ai_pid: "AI-PID",
        c_speed_controller_none: "NONE",
        c_speed_controller_fix_pwm: "FIX PWM",
        c_speed_controller_pid: "PID",
        ...
        menu_load_route: "📂 Load Route",
        menu_save_route: "💾 Save Route",
        ...
        desc_heading_reference: "North/East is 0°",
        heading_mode_north_cw: "STANDARD",
        heading_mode_east_ccw: "REP",
        style_cyber: "CYBER",
        style_ios: "iOS",
        ...
        btn_save_new_route: "SAVE NEW",
        btn_overwrite_route: "OVERWRITE ROUTE",
        btn_cancel: "CANCEL",
        ...
        route_points: "Points",
        save_route_hint: "Save the current map waypoints into the route library",
        unnamed_route: "Unnamed Route",
        route_delete_confirm: "Delete route \"{name}\"?",
        route_load_confirm_replace: "The current route has unsaved changes. Discard them and load the selected route?",
        route_save_exists_confirm: "A route with the same name already exists. Replace it?",
        route_favorite: "Pin Favorite",
        route_unfavorite: "Unpin Favorite",
        route_save_failed: "Failed to save route.",
        route_rename_failed: "Failed to rename route.",
        route_delete_failed: "Failed to delete route.",
        route_favorite_failed: "Failed to update favorite route.",
        route_load_failed: "Failed to load route.",
        toast_route_saved: "Route saved",
        toast_route_loaded: "Route loaded",
